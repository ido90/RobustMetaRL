...
def get_args(rest_args):
    ...
    parser.add_argument('--num_frames', type=int, default=10e7, help='number of frames to train')
    ...
    parser.add_argument('--env_name', default='HalfCheetahMultiMass-v0', help='environment to train on')
