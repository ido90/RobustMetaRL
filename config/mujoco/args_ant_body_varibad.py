...
def get_args(rest_args):
    ...
    parser.add_argument('--num_frames', type=int, default=7e7, help='number of frames to train')
    ...
    parser.add_argument('--env_name', default='AntBody-v0', help='environment to train on')
